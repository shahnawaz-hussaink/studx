        ...
        <div className="flex justify-center">
          <div className="flex bg-white h-full sticky top-0 w-1/3">
            <div>
              <img
                src={product.image}
                className="h-130 p-10 object-contain my-10"
              />
            </div>
          </div>
          <div className="m-10 w-2/3 ">
            <div className="w-2/4 ">
              ...
              <p className="raleway text-sm font-black text-gray-500 pb-5">
                Sell by{" "}
                <a className="text-black pointer-cursor">
                  {product.seller?.name}
                </a>
              </p>

              <p className="text-2xl  pb-5">₹ {product.price}.00</p>
            </div>
            <div>
              <div className="flex gap-4 mt-4">
                ...
                <a
                  ...
                  className="px-6 py-2 border-2 border-orange-500 text-orange-500 rounded-xl hover:bg-orange-50 transition"
                >
                  Contact Seller
                </a>
              </div>
